    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto p-4 md:p-8 space-y-6 md:space-y-8 bg-background">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl md:text-4xl font-bold mb-6 md:mb-8">Privacy Policy</h1>
          
          <section className="space-y-6">
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">1. Data Collection and Usage</h2>
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">2. Financial Information Security</h2>
            <p className="text-muted-foreground text-sm md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">3. Data Storage and Retention</h2>
            <p className="text-muted-foreground text-sm md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">4. Third-Party Services</h2>
            <p className="text-muted-foreground text-sm md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">5. User Rights</h2>
            <p className="text-muted-foreground text-sm md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">6. Updates to Privacy Policy</h2>
            <p className="text-muted-foreground text-sm md:text-base">
